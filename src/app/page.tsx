...
import { formatDate, formatNumber, formatTime, pluralize } from "@/lib/utils";
import {
  actionQueue,
  attentionList,
  dashboardSnapshot,
...
export default async function DashboardPage() {
  ...
  const actions = actionQueue(10);
  const attention = attentionList(5);
    ...
    <>
      ...
      <PageBody>
        ...
        <div className="grid gap-5 xl:grid-cols-3">
          {/* ---------- Action queue ---------- */}
          <Card className="flex flex-col xl:row-span-2" padded={false}>
